...
exports.run = async (client, message, args) => {
	...
	const embed = new RichEmbed()
		...
		.addField("Client", target.user.presence.clientStatus ? Object.keys(target.user.presence.clientStatus).map(client => ({"web": "Web", "desktop": "Desktop", "mobile": "Mobile"}[client])).join(", ") : "None", true)
